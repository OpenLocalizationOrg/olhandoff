...
Attached properties exist mostly because they enabled a XAML syntax. In XAML, you set attached properties by using the syntax *AttachedPropertyProvider***.***PropertyName*. Here is an example of how you can set [**Canvas.Left**](https://msdn.microsoft.com/library/windows/apps/hh759771) in XAML.
